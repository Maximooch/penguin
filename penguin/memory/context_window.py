...
class ContextWindowManager:
    ...
    def manage_context(self, messages: List[Dict[str, Any]], token_count: int) -> Tuple[List[Dict[str, Any]], bool]:
        """
        ...
        truncated_non_system_messages = self._truncate_oldest_non_system_messages(non_system_messages)
    ...
    def _truncate_oldest_non_system_messages(self, messages: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        total_tokens = 0
        truncated_messages = []
