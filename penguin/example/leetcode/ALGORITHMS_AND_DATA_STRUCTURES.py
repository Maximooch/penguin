# Common Algorithms and Data Structures for LeetCode Problems

# This file contains implementations of frequently used algorithms and data structures
# that can be helpful when solving LeetCode problems.
...
if __name__ == "__main__":
    ...
    uf.union(2, 3)
    uf.union(1, 2)
    print("Union-Find:", [uf.find(i) for i in range(5)])
    ...
    print("Trie starts with 'apr':", trie.starts_with("apr"))