...
class CodeIndexer:
        ...
        for doc, meta, distance in zip(results['documents'][0], results['metadatas'][0], results['distances'][0]):
            ...
            if relevant_ast['functions'] or relevant_ast['classes']:
                ...
                if line_range:
                    ...
                    content = '\n'.join(content_lines[line_range[0]-1:line_range[1]])
    ...
    def find_relevant_ast(self, query: str, ast_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for item in ast_info['functions']:
            ...
            elif any(all(part in arg.lower() for part in query_parts) for arg in item['args']):
                relevant_ast['functions'].append(item)
    ...
    def wait_for_initialization(self):
        ...
        try:
            ...
            logging.error(f"Error waiting for workspace indexer initialization: {str(e)}")
            raise
