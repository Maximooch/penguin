...
class CoreToolsPlugin(BasePlugin):
    ...
    def _list_files_tool(self):
        ...
        return ToolDefinition(
            ...
            extensions=None,
            recursive=False: list_files_filtered(directory, extensions, recursive),
            category="filesystem",
    ...
    def _find_file_tool(self):
        ...
        return ToolDefinition(
            ...
            directory=".",
            case_sensitive=False: find_files_enhanced(
    ...
    def _apply_diff_tool(self):
        ...
        return ToolDefinition(
            ...
            handler=lambda file_path, diff_content: apply_diff_to_file(
    ...
    def _edit_with_pattern_tool(self):
        ...
        return ToolDefinition(
            ...
            handler=lambda file_path,
            pattern,
            replacement,
            regex=False: edit_file_with_pattern(
                file_path=file_path,
