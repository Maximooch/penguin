...
def mock_core():
    ...
    core.ensure_agent_conversation = MagicMock()
    core.create_sub_agent = MagicMock()
    core.set_active_agent = MagicMock()
...
class TestPenguinClientAgents:
    ...
    def test_create_agent_registers(self, mock_core):
        ...
        mock_core.ensure_agent_conversation.assert_called_once_with(
            "planner", system_prompt="You are a planner"
        )
        mock_core.register_agent.assert_not_called()
